...
//!
//! Merge order matters: earlier profiles are the base, later profiles
//! overlay. Use case: `parse(resume.pdf)` then overlay `parse(linkedin.zip)`
//! so LinkedIn's cleaner structured data wins ties.
//!
//! De-duplication:
