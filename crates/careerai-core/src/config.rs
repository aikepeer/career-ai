...
pub struct SourcesConfig {
    ...
    /// Native LinkedIn browser-driven discovery source. Drives a
    /// stealth Chromium session against `linkedin.com/jobs/search/`
    /// using the same `li_at` cookie + stealth-v2.js infrastructure as
    /// the M5 submitter. Defaults to `enabled: false`; user opts in
    /// after acknowledging the LinkedIn ToS §8.2 trade-off.
